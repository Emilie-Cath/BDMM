...
sd_lambda=0.02
alpha_lambda=mean_lambda^2/sd_lambda^2
beta_lambda=mean_lambda/sd_lambda^2
...
#lambda system
alpha_real=lambda^2/sd_lambda^2
beta_real=lambda/sd_lambda^2
...
title_bias=paste0("Bias_lam_",lambda_data,"_run2.csv")
